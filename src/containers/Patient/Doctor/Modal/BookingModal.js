...
class BookingModal extends Component {
    ...
    buildDataGender = (data) => {
        ...
        console.log('result in build gender data', result);
    ...
    buildDoctorName = (dataTime) => {
        ...
        if (dataTime && !_.isEmpty(dataTime)) {
            let name = language === LANGUAGE.VI ?
                ...
                :
                `${dataTime.doctorData.firsName} ${dataTime.doctorData.lasttName}`
    ...
    render() {
        ...
        let doctorId = ''
        if (dataTime && !_.isEmpty(dataTime)) {
            console.log('data time', dataTime.doctorId);
